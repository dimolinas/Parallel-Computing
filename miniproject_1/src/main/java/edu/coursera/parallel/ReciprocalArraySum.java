...
public final class ReciprocalArraySum {
    ...
    /**
     * implement the reciprocal-array-sum computation in parallel using the Java Fork Join framework
     * partitioning the input array in half and computing the reciprocal array sum
     * on the first and second half in parallel, before combining the results
    */
    /**
    ...
    protected static double parManyTaskArraySum(final double[] input, final int numTasks) {
        ...
        for (int i = 0; i < numTasks; i++){
            tasks[i] = new ReciprocalArraySumTask(getChunkStartInclusive(i, numTasks, length),getChunkEndExclusive(i, numTasks, length), input);
        }
